...
INSERT INTO `constants` VALUES (1,'ru','http://localhost/new_project','Название сайта','Не является публичной офертой',2,'daniil_panov2005@mail.ru',2),(2,'en','http://localhost/new_project','Site name','Not a public offer',3,'daniil_panov2005@mail.ru',1),(3,'ru','http://localhost/new_project','Название Сайта','Не является публичной офертой',3,'daniil_panov2005@mail.ru',2),(4,'en','http://localhost/new_project','Site name','Not a public offer',3,'daniil_panov2005@mail.ru',2);
...
INSERT INTO `languages` VALUES (1,'ru','русский','1','1'),(2,'en','english','1','0'),(3,'ru','русский','1','1'),(4,'en','english','1','0');
...
INSERT INTO `pages` VALUES (1,0,'','','адрес сайта | Ключевое слово | Главная','icon-home','icon-large',1,'Главная',1,'Главная','ru',1504795508,0,'1','1','1','1','1','1','1'),(2,0,'','','site address | Keyword | Main','icon-home','icon-large',2,'Main',17,'Main','en',1504795508,0,'1','1','1','1','1','1','1'),(3,1,'','','адрес сайта | Ключевое слово | Пример страницы','','',1,'Пример страницы',2,'<p>\r\n	Пример страницы</p>\r\n','ru',1504795508,1521807375,'1','1','1','1','1','1','0'),(4,2,'','','site address | Keyword | Example page','','',2,'Example page',18,'Example page','en',1504795508,0,'1','0','1','1','1','0','0'),(9,0,'','','site address | Keyword | Main','icon-home','icon-large',2,'Main',3,'Main','en',1541071636,0,'1','1','1','1','0','0','1'),(10,1,'','','адрес сайта | Ключевое слово | Пример страницы','','',1,'Пример страницы',2,'Пример страницы','ru',1541071636,0,'1','0','1','1','1','0','0'),(11,2,'','','site address | Keyword | Example page','','',2,'Example page',4,'Example page','en',1541071636,0,'1','0','1','1','1','0','0');
...
INSERT INTO `users` VALUES (1,'admin','42f3d4cf9443bb1cbf053f7933f37d98'),(2,'admin','827ccb0eea8a706c4c34a16891f84e7b');
...
-- Dump completed on 2018-11-03 11:42:04
