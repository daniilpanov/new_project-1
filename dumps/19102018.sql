...
INSERT INTO `pages` VALUES (1,0,'','','адрес сайта | Ключевое слово | Главная','icon-home','icon-large',1,'Главная',1,'Главная','ru',1504795508,0,'1','1','1','1','1','1','1'),(2,0,'','','site address | Keyword | Main','icon-home','icon-large',2,'Main',15,'Main','en',1504795508,0,'1','1','1','1','1','1','1'),(3,1,'','','адрес сайта | Ключевое слово | Пример страницы','','',1,'Пример страницы',2,'<p>\r\n	Пример страницы</p>\r\n','ru',1504795508,1521807375,'1','1','1','1','1','1','0'),(4,2,'','','site address | Keyword | Example page','','',2,'Example page',16,'Example page','en',1504795508,0,'1','0','1','1','1','0','0');
...
-- Dump completed on 2018-10-19 18:48:54
