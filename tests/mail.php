...
if (isset ($_POST['contactFF'])) {
  $to = "mra62@rambler.ru";
  $from = "office@art-metall.ru";
  $subject = "Новая заявка с сайта art-metall.ru";
  $message = "<html><head></head><body>Имя: ".$_POST['nameFF']."<br>Email: ".$_POST['contactFF']."<br>IP: ".$_SERVER['REMOTE_ADDR']."<br>Сообщение: ".$_POST['messageFF']."</body></html>";
  $boundary = md5(date('r'));
  $filesize = 0;
...
--$boundary--";
  ...
  if ($filesize < 10000000) {
    ...
    $output = '<script>alert("Ваше сообщение успешно отправлено, спасибо!");</script>';
  } else {
...
<label for="fileFF"><?=ATTACHMENT?>:</label>
...
<br>
<input value="<?=SEND?>" type="submit" id="submitFF">
</form>